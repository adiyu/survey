		...
		if (@$registrant_id) {
			...
			if (@$kuesionerWajib) {
				...
				if (@$kuesionerOpsional) {
	                ...
	                $message .= "<a href='".base_url($hrefUrl)."' style='cursor: pointer;'><button style='background-color: #082B59; color: #FFF; width: 300px; height: 35px; font-size: 15px; border-radius: 5px;'>Edit Survey Anda</button></a>";
