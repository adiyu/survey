...
<body>
	<img src="<?= base_url('public/assets/kopSurat.png'); ?>" style="width: 100%;">
	<p style="font-weight: bold; float: right;"><?= date('d F Y', strtotime($kuesioner->created_at)); ?></p>
	<table>
		<tr>
			<td style="padding-top: 10px; font-size: 18px; font-weight: bold;">Nomor</td>
			<td style="padding-top: 10px;"> : </td>
			<td style="padding-top: 10px;font-size: 18px;">1997/E2/WA.01.04/<?= date('Y'); ?></td>
		</tr>
		<tr>
			<td style="padding-top: 10px;font-size: 18px; font-weight: bold;">Lapiran</td>
			<td style="padding-top: 10px;"> : </td>
			<td style="padding-top: 10px;font-size: 18px;">1 (Satu) lembar</td>
		</tr>
		<tr>
			<td style="padding-top: 10px;font-size: 18px; font-weight: bold;">Hal</td>
			<td style="padding-top: 10px;"> : </td>
			<td style="padding-top: 10px;font-size: 18px; font-weight: bold">Pelaporan Hasil Pelacakan Jejak Alumni (Tracer Study) Tahun 2022.</td>
		</tr>
	</table>
	<p style="margin-top: 15px;  font-size: 17px;">Yth. Pimpinan Perguruan Tinggi.</p>
	<p style="margin-top: 10px; line-height: 20px; font-size: 17px;">Dalam rangka peningkatan kualitas Perguruan Tinggi dan terkait pengukuran Indikator Kinerja Utama (IKU) 1 Perguruan Tinggi (PT) sesuai Keputusan Menteri Pendidikan dan Kebudayaan No. 754 Tahun 2020 , dengan hormat kami sampaikan agar Pimpinan Perguruan Tinggi dapat melaporkan hasil pelacakan jejak alumni (Tracer Study) dengan ketentuan sebagai berikut:</p>
	<ol style=" line-height: 20px; font-size: 17px;">
		<li>Pelaporan dilakukan oleh operator perguruan tinggi melalui laman: http://tracerstudy.kemdikbud.go.id/</li>
		<li>Hasil yang dilaporkan adalah pelacakan jejak alumni (Tracer Study) untuk lulusan tahun 2021 yang dilaksanakan secara mandiri oleh perguruan tinggi.</li>
	</ol>
	<p style="margin-top: 10px;  font-size: 17px;">Pelaksanaan tracer study dilaporkan sesuai dengan pelaporan indikator kinerja PT dan kementerian dalam 4 (empat) triwulan yaitu periode Maret, Juni, September dan Desember.</p>
	<p style="margin-top: 10px;  font-size: 17px;">Untuk itu kami mohon kerjasama Bapak/Ibu Pimpinan Perguruan Tinggi untuk dapat melaporkan pelaksanaan hasil pelacakan jejak alumni (Tracer Study).</p>
	<p style="margin-top: 10px;  font-size: 17px;">Demikian untuk diketahui, atas perhatian dan kerjasamanya kami mengucapkan terima kasih</p>
	<p style="font-weight: bold; margin-top: 10px;  font-size: 17px; float: right;">Plt. Direktur Pembelajaran dan<br>Kemahasiswaan,
	<br><br><br><br><br>
	Kiki Yuliati<br>NIP 196407051988032002</p>
	<p style="font-weight: bold; margin-top: 230px; font-size: 17px;">Tembusan :<br>Plt. Direktur Jenderal Pendidikan Tinggi, Riset, dan Teknologi</p>
	<br><br><br><br>
	<!-- Halaman Dua -->
	<p style="font-size: 17px; margin-top: -10px;">Lampiran</p>
	<p style="font-size: 17px; margin-top: -10px;">Nomor : 1997/E2/WA.01.04/<?= date('Y'); ?></p>
	<p style="font-size: 17px; margin-top: -10px;">Tanggal : <?= date('d m Y', strtotime($kuesioner->created_at)); ?></p>
	<br><br><br>
