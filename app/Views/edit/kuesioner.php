                            ...
                            <div id="middle-wizard">
                                <div class="step">
                                    ...
                                    <div class="form-group">
                                        <input type="text" value="<?= @$k->nomor_mahasiswa; ?>" name="nomor_mahasiswa" class="form-control " placeholder="Nomor Mahasiswa" />
                                    </div>
                                    <div class="form-group">
                                        <input type="text" value="<?= @$k->nik_mahasiswa; ?>" name="nik_mahasiswa" class="form-control " placeholder="NIK Mahasiswa" />
                                    </div>
                                    <div class="form-group">
                                        <input type="text" value="<?= @$k->nama_mahasiswa; ?>" name="nama_mahasiswa" class="form-control " placeholder="Nama Mahasiswa" />
                                    </div>
                                    <div class="form-group">
